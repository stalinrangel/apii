...
$contenido = '<html><body>
        ...
        <p>I- La zona que se adopte una cuota por el monto de '.$costo.'.$ según el plan <b>"'.$plan.'. El Proveedor debe abonar la suma correspondiente al plan contratado a través de Red Pagos, Mi Dinero Nº 5351231."</b>.</p> 
